...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form id="product-edit-form" class="form d-flex flex-column flex-lg-row"
                        ...
                        <div class="card-body pt-0 text-center">
                            <style>
                                .image-input-placeholder {
                                    background-image: url("{{ Storage::url($product->thumbnailMedia->path) }}");
                        ...
                        <div class="card-body pt-0">
                            <select class="form-select" name="category" id="category" data-control="select2"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" @if ($product->productSeri->category_id == $category->id) selected @endif>
                            ...
                            <div class="mt-5">
                                ...
                                <select name="product_seri" id="product-seri" class="form-select" data-control="select2"
                                    data-placeholder="Chọn dòng sản phẩm">
                                    <option></option>
                                    @foreach ($product->productSeri->category->productSeries as $productSeri)
                                        <option value="{{ $productSeri->id }}"
                                            @if ($product->product_seri_id == $productSeri->id) selected @endif>{{ $productSeri->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <textarea type="text" name="short_description" class="form-control mb-2" placeholder="Mô tả ngắn về sản phẩm"
                                                maxlength="255">{{ $product->short_description }}</textarea>
                                ...
                                <div class="card card-flush mb-10 py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div>
                                            ...
                                            @include('product.components.product_option_edit_form')
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-primary">
                                <span class="indicator-label">Cập nhật sản phẩm</span>
                            </button>
                        </div>
                    </div>
            </form>
