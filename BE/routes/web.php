...
Route::prefix('order')->namespace('App\Http\Controllers\Admin')->group(function () {
    Route::get('vnpay_payment_complete/{id}', 'OrderController@vnpayPaymentComplete')->name('order.vnpay_payment_complete');
});
