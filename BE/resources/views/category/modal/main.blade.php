                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="scroll-y me-n7 pe-7" id="modal-scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-semibold mb-2">Tên danh mục</label>
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Ex: Laptop văn phòng" name="name" />
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.code == 0) {
                        ...
                        toastr.success(!data.id ? "Thêm mới danh mục thành công!" : "Sửa thử mục thành công!");
